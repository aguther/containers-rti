...
sudo echo "Environment=\"HTTP_PROXY=http://127.0.0.1:3128/\""	>>	$DOCKER_PROXY_CONFIGURATION_FILE
sudo echo "Environment=\"HTTPS_PROXY=http://127.0.0.1:3128/\""	>>	$DOCKER_PROXY_CONFIGURATION_FILE
