...
vagrant destroy -f
vagrant up
vagrant ssh -c "cd /vagrant; ansible-playbook -i /tmp/vagrant-ansible/inventory/vagrant_ansible_local_inventory -e rti_perftest_id=1 rti-perftest-kubernetes-start.yml"
----

=== Stop
[source,bash]
----
vagrant ssh -c "cd /vagrant; ansible-playbook -i /tmp/vagrant-ansible/inventory/vagrant_ansible_local_inventory -e rti_perftest_id=1 rti-perftest-kubernetes-stop.yml"
----
