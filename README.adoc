...
=== Monitoring
Monitoring can be done using the Kubernetes Dashboard UI. It can be reached on the address `http://<host>:32000`. Additionally you can also access the tool cockpit which can be reached on the address `http://<host>:9090`.
